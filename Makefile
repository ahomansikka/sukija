...
SOLR_HOME=${HOME}/Lataukset/solr/solr-5.0.0/server/solr/sukija
JETTY_CONTEXTS_DIR=${HOME}/Lataukset/solr/solr-5.0.0/server/context
...
#        fi
	...
	if [ -e ${SOLR_HOME}/conf/velocity ]; then \
