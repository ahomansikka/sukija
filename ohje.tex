...
\verb=$HOME/Lataukset/solr/solr-4.5.1=
...
%Esimerkiksi sanaa ''huuhaa'' etsitään menemällä verkko-osoitteeseen
%{\footnotesize
%\verb|http://localhost:8983/solr/collection1/select?q=huuhaa&df=text&wt=xslt&tr=sukija.xsl|}
