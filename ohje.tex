...
\item Javan versio 17. Sukija ei ehkä käänny Javan aiemmilla versiolla.
...
Solr:n versiosta 9.0.0 on poistettu \verb=DataImportHandler=, jota
käytin kovalevyni indeksointiin, ja Sen korvaajaksi tein ohjelman
