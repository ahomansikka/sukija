...
\verb=$HOME/Lataukset/solr/solr-4.7.0=
...
\begin{verbatim}
cd $HOME/Lataukset/solr/solr-4.7.0/example
java -jar start.jar
\end{verbatim}
...
\verb=solr-4.7.0/example/resources/log4j.properties=
...
Lokitulostus menee tiedostoon \verb=solr-4.7.0/example/logs/solr.log=
