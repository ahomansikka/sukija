...
Jos ne ovat jossain muualla, tiedoston \verb=Makefile= alussa oleaa
muuttujaa \verb=SOLR= pitää muuttaa vastaavasti.
...
\bigskip Toisessa vaiheessa konfiguroidaan Solr tiedostossa \verb|sukija.properties|
Katso ohjeet äsken mainitusta tiedostosta.
...
\verb|conf/sukija-context.xml|

muutokset voi viedä Solr:iin komennolla \verb|make päivitä-asennus|
...
\verb=solr-x.y.z/server/resources/log4j.properties=
...
Lokitulostus menee tiedostoon \verb=solr-x.y.z/server/logs/solr.log=
...
Konfiguroititiedostossa olevien säännöllisten lausekkeiden syntaksi on
...
\verb|java -jar sukija-ui/target/sukija-ui-1.1.jar|
