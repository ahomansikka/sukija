...
\verb=$HOME/Lataukset/solr/solr-4.6.1=
...
\begin{verbatim}
cd $HOME/Lataukset/solr/solr-4.6.1/example
java -jar start.jar
\end{verbatim}
...
\verb=solr-4.6.1/example/resources/log4j.properties=
...
Lokitulostus menee tiedostoon \verb=solr-4.6.1/example/logs/solr.log=
