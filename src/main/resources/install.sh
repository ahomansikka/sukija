...
cp ${HOME}/.m2/repository/org/glassfish/jaxb/jaxb-runtime/4.0.5/jaxb-runtime-4.0.5.jar /var/solr/data/sukija/lib/
cp ${HOME}/.m2/repository/org/glassfish/jaxb/jaxb-core/4.0.5/jaxb-core-4.0.5.jar /var/solr/data/sukija/lib/
