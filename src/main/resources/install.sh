...
cp $HOME/.m2/repository/peltomaa/sukija/sukija/2.2.12/sukija-2.2.12.jar /var/solr/data/sukija/lib/
...
cp $HOME/.m2/repository/javax/xml/bind/jaxb-api/2.3.0/jaxb-api-2.3.0.jar /var/solr/data/sukija/lib/
...
cp $HOME/.m2/repository/com/sun/istack/istack-commons-runtime/3.0.5/istack-commons-runtime-3.0.5.jar /var/solr/data/sukija/lib/
