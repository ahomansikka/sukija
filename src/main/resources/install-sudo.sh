...
sudo -u solr cp $HOME/.m2/repository/peltomaa/sukija/sukija/2.2.21/sukija-2.2.21.jar /var/solr/data/sukija/lib/
...
sudo -u solr cp $HOME/.m2/repository/javax/xml/bind/jaxb-api/2.4.0-b180725.0427/jaxb-api-2.4.0-b180725.0427.jar /var/solr/data/sukija/lib/
...
sudo -u solr cp $HOME/.m2/repository/com/sun/istack/istack-commons-runtime/3.0.6/istack-commons-runtime-3.0.6.jar /var/solr/data/sukija/lib/
