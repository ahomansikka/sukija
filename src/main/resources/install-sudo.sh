...
sudo -u solr cp $HOME/.m2/repository/org/puimula/voikko/libvoikko/4.0.1/libvoikko-4.0.1.jar /var/solr/data/sukija/lib/
sudo -u solr cp $HOME/.m2/repository/peltomaa/sukija/sukija/2.1.5/sukija-2.1.5.jar /var/solr/data/sukija/lib/
sudo -u solr cp $HOME/.m2/repository/org/ahocorasick/ahocorasick/0.3.0/ahocorasick-0.3.0.jar /var/solr/data/sukija/lib/
