...
public class SuggestionTest extends TestCase {
  ...
  public void testSuggestion()
  {
    try {
      ...
      Suggestion h_suggestion = new RegexSuggestion (morphology, "V(h)V", "");

      assertTrue (test (morphology, "joutilahan",    "joutilas", h_suggestion));
      assertTrue (test (morphology, "oppilahittesi", "oppilas",  h_suggestion));
      assertTrue (test (morphology, "sotilahat",     "sotilas",  h_suggestion));
    }
    catch (IOException t)
    {
